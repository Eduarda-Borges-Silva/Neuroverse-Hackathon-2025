...
> ⚠ *Requisito de versão: este projeto requer **Python 3.12.3*.
...
* 🗄 *Banco de Dados* (rol de procedimentos carregado via planilha)
* 🗓 *Agendamento de Consultas* com bloqueio automático de horários
